...
API Authentication
The FastAPI service is protected with basic HTTP authentication.
...
Note: Some browsers cache credentials. If you don’t see a login prompt again, try an incognito window or a tool like Postman or curl.
